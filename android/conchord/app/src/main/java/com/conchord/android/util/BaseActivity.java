...
import com.conchord.android.util.*;
...
public class BaseActivity extends PreferenceActivity {
	...
	*//**
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// bind to NtpSync
		bindService(new Intent(INtpSyncRemoteService.class.getName()),
	...
	*//**
	 ...
	 * 
	 * IPC calls via AIDL are synchronous in Android!!! Because of that we need
	 * to call the methods from AsyncTask or IntentService to not block the UI
	 *//*
		...
		AsyncTask<Void, Void, Integer> getTimeTask = new AsyncTask<Void, Void, Integer>() {
			...
			protected void onPostExecute(Integer result) {
				...
				case RETURN_SERVER_TIMEOUT:
					toast = Toast.makeText(mActivity, "Server timeout!",
							Toast.LENGTH_LONG);
					toast.show();
