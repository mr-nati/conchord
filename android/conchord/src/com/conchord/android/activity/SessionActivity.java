...
public class SessionActivity extends Activity {
	...
	static Firebase mySessionIdFirebase;
	...
	private void connectToFirebase() {
		...
		String pushedName = mySessionIdFirebase.getName();
		mySessionID = mySessionIdFirebase.getName();

		Log.d(TAG,
				"mySessionIDFirebase.getName()" + mySessionIdFirebase.getName());
	...
	protected void onPause() {
		...
		Log.d(TAG, "getRef() before = " + mySessionIdFirebase.getRef().getName());
		//mySessionIdFirebase.getRef().removeValue();
		Log.d(TAG, "getPath.toString() = " + mySessionIdFirebase.getPath().toString()); 
		mySessionIdFirebase.getRoot().child(mySessionIdFirebase.getPath().toString()).removeValue();;
		Log.d(TAG, "getRef() after = " + mySessionIdFirebase.getRef().getName());
		Log.d(TAG, "removing mysessionidfirebase");
		super.onPause();
	}
